...
class Cluster(object):
    ...
    def eval_asnewobject(self):
        ...
        if (0 == self.s_NumAssocObjs) and (EM_CLU_VALID == self.u_InvalidReasonBitField) and (self.s_ClusterKinematicID == 'Dynamic') and (EM_CLU_HRR_SCAN_BIT != (EM_CLU_HRR_SCAN_BIT & self.u_PropertiesBitField)):
